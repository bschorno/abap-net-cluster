...
{
    public class Read_StringTable
    {
        [Fact]
        public void Read_String_Table()
        {
            DataBuffer dataBuffer = new DataBuffer();

            var structExpected = new ClusterWithStringTable()
            {
                Table = new string[] {
                    "AA",
                    "BBBB"
            ...
            var structActual = dataBuffer.Import<ClusterWithStringTable>(new byte[] {
